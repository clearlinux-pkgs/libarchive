...
Source0  : https://github.com/libarchive/libarchive/releases/download/v3.7.4/libarchive-3.7.4.tar.gz
Source1  : https://github.com/libarchive/libarchive/releases/download/v3.7.4/libarchive-3.7.4.tar.gz.asc
...
%setup -q -n libarchive-3.7.4
cd %{_builddir}/libarchive-3.7.4
pushd ..
cp -a libarchive-3.7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714511680
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libarchive.so.13.7.4
