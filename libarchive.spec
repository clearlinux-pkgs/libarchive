...
Source0  : http://www.libarchive.org/downloads/libarchive-3.3.0.tar.gz
...
%prep
%setup -q -n libarchive-3.3.0
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487694830
...
/usr/lib64/libarchive.so.13.3.0
