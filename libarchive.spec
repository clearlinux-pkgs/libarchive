...
%setup -q -n libarchive-3.7.7
cd %{_builddir}/libarchive-3.7.7
pushd ..
cp -a libarchive-3.7.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731516608
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libarchive.so.13.7.7
