...
Version  : 3.5.0
Release  : 60
URL      : https://github.com/libarchive/libarchive/releases/download/v3.5.0/libarchive-3.5.0.tar.xz
Source0  : https://github.com/libarchive/libarchive/releases/download/v3.5.0/libarchive-3.5.0.tar.xz
Source1  : https://github.com/libarchive/libarchive/releases/download/v3.5.0/libarchive-3.5.0.tar.xz.asc
...
%prep
%setup -q -n libarchive-3.5.0
cd %{_builddir}/libarchive-3.5.0
pushd ..
cp -a libarchive-3.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606875380
...
cp %{_builddir}/libarchive-3.5.0/COPYING %{buildroot}/usr/share/package-licenses/libarchive/90ba482db24552fe26fffe459bbc350224a79b3a
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
...
/usr/lib64/haswell/libarchive.so.13.5.0
/usr/lib64/libarchive.so.13
/usr/lib64/libarchive.so.13.5.0
